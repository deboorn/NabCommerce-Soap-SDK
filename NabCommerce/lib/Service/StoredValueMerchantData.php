...
class StoredValueMerchantData
{
     ...
     */
    protected $AgentChain = nunull
    /**
     * @var string $ClientNumber
     */
    protected $ClientNumber = nunull
    /**
     * @var IndustryType $IndustryType
     */
    protected $IndustryType = nunull
    /**
     * @var string $SIC
     */
    protected $SIC = nunull
    /**
     * @var string $StoreId
     */
    protected $StoreId = nunull
    /**
     * @var string $TerminalId
     */
    protected $TerminalId = nunull
    /**
