...
class Acknowledge
{
     ...
     */
    public function __construct($sessionToken, $transactionId, $applicationProfileId, $workflowId)
    {
     ...
     * @param string $workflowId
     */
    public static function forge($sessionToken, $transactionId, $applicationProfileId, $workflowId)
    {
        return new self($sessionToken, $transactionId, $applicationProfileId, $workflowId);
    }
    ...
    /**
     * @param string $sessionToken
     * @return \NabCommerce\Transaction\Acknowledge
     */
