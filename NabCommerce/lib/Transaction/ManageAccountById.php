...
class ManageAccountById
{
    ...
    /**
     * @param string $sessionToken
     * @return \NabCommerce\Transaction\ManageAccountById
     */
     ...
     * @return \NabCommerce\Transaction\ManageAccountById
     */
    public function setDifferenceData(Manage $differenceData)
    {
        $this->differenceData = $differenceData;
        return $this;
    }
