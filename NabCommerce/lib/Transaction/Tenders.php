...
class Tenders
{
     ...
     */
    protected $CreditReversalSupportType = null;

    /**
     * @var PartialApprovalSupportType $PartialApprovalSupportType
     */
    protected $PartialApprovalSupportType = null;
